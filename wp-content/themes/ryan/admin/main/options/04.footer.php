...
function thinkup_input_copyright() {
	...
	printf( __( 'Developed by %1$s. Powered by %2$s.', 'ryan' ) , '<a href="//www.thinkupthemes.com/" target="_blank">Think Up Themes Ltd</a>', '<a href="' . esc_url( __( '//wordpress.org/', 'ryan' ) ) . '" target="_blank">WordPress</a>');
}